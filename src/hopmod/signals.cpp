...
boost::signal<void (int)> signal_checkmaps;
...
boost::signal<void (int, const char *)> signal_takeflag;
boost::signal<void (int, const char *)> signal_dropflag;
boost::signal<void (int, const char *)> signal_scoreflag;
boost::signal<void (int, const char *)> signal_returnflag;
boost::signal<void (const char *)> signal_resetflag;
