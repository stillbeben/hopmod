...
lua::event< boost::tuple<int,const char *,const char *> >            event_authreq("authreq");
lua::event< boost::tuple<int,int,const char *> >                     event_authrep("authrep");
...
lua::event< boost::tuple<int, const char *> >                        event_scoreflag("scoreflag");
