...
server.event_handler("started", function()
    ...
    if server.allow_only_public_mastermodes == 1 then
        dofile("./script/allow_only_public_mastermodes.lua")
    elseif server.allow_only_nonpublic_mastermodes == 1 then
        dofile("./script/allow_only_nonpublic_mastermodes.lua")
    elseif server.disallow_private_mastermode == 1 then
	dofile("./script/disallow_private_mastermode.lua")
    end
    
    if server.use_cd_weapon_reload_time == 1 then
        dofile("./script/cd_weaponreloadtime.lua")
    end
	...
	dofile("./script/teambalance_bot.lua")
    elseif server.use_teambalancer_xonx == 1 then
        dofile("./script/teambalance_bot_xonx.lua")
    end
