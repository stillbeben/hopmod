...
local size_gamemode = {
    ...
    ["efficiency ctf"]		= server.resize_server_gamemode_size_effic_ctf		or max_players,
    ...
    ["efficiency protect"]	= server.resize_server_gamemode_size_effic_protect	or max_players,
    ...
    ["efficiency hold"]		= server.resize_server_gamemode_size_effic_hold		or max_players,
    ...
    ["efficiency team"]		= server.resize_server_gamemode_size_effic_team		or max_players,
    ["efficiency"]		= server.resize_server_gamemode_size_effic		or max_players,
    ["tactics team"]		= server.resize_server_gamemode_size_tactics_team	or max_players,
    ["tactics"]			= server.resize_server_gamemode_size_tactics		or max_players,
    ["instagib team"]		= server.resize_server_gamemode_size_insta_team		or max_players,
