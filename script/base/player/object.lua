...
local methods = {
    ...
    kick            = function(obj, ...) return server.kick(obj.cn, table.unpack({...})) end,
    disconnect      = function(obj, ...) return server.disconnect(obj.cn, table.unpack({...})) end,
    ...
    suicide         = function(obj) return server.player_suicide(obj.cn) end,
